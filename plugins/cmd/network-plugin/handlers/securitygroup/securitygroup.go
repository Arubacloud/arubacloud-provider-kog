...
func (h *getHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to get securitygroup
	// response, err := arubaSDK.GetSecuritygroup(projectId, id)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "GET securitygroup not yet implemented - integrate Aruba Cloud SDK here",
	})
}
...
func (h *postHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to create securitygroup
	// response, err := arubaSDK.CreateSecuritygroup(projectId, req)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "POST securitygroup not yet implemented - integrate Aruba Cloud SDK here",
	})
}
...
func (h *putHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to update securitygroup
	// response, err := arubaSDK.UpdateSecuritygroup(projectId, id, req)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "PUT securitygroup not yet implemented - integrate Aruba Cloud SDK here",
	})
}
...
func (h *listHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to list securitygroups
	// response, err := arubaSDK.ListSecuritygroups(projectId)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "LIST securitygroups not yet implemented - integrate Aruba Cloud SDK here",
	})
}

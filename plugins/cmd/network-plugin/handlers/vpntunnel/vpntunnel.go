...
func (h *getHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to get vpntunnel
	// response, err := arubaSDK.GetVpntunnel(projectId, id)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "GET vpntunnel not yet implemented - integrate Aruba Cloud SDK here",
	})
}
...
func (h *postHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to create vpntunnel
	// response, err := arubaSDK.CreateVpntunnel(projectId, req)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "POST vpntunnel not yet implemented - integrate Aruba Cloud SDK here",
	})
}
...
func (h *putHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to update vpntunnel
	// response, err := arubaSDK.UpdateVpntunnel(projectId, id, req)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "PUT vpntunnel not yet implemented - integrate Aruba Cloud SDK here",
	})
}
...
func (h *listHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Call Aruba Cloud SDK to list vpntunnels
	// response, err := arubaSDK.ListVpntunnels(projectId)
	
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusNotImplemented)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "LIST vpntunnels not yet implemented - integrate Aruba Cloud SDK here",
	})
}

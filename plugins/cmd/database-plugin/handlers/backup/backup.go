...
func (h *getHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	response, err := client.FromDatabase().Backups().Get(r.Context(), projectId, id, params)
	if err != nil {
...
func (h *postHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	response, err := client.FromDatabase().Backups().Create(r.Context(), projectId, req, params)
	if err != nil {
...
func (h *putHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	// Backups resource does not support Update operation
	h.Log.Print("PUT backup operation not supported by Aruba Cloud API")

	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusMethodNotAllowed)
	json.NewEncoder(w).Encode(map[string]string{
		"message": "PUT operation not supported for database backups",
	})
}
...
func (h *listHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	response, err := client.FromDatabase().Backups().List(r.Context(), projectId, params)
	if err != nil {
